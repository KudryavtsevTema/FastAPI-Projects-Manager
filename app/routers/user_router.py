...
from app.schemas.users import UserSchema, UserInDB
from app.services.auth_service import AuthService, checking_credentials, get_auth_service
...
@secure_router.post("/registry", response_model=UserSchema)
